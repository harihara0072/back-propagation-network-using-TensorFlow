...
import Nakshatrala_04_02 as k02  # This module is for plotting components
import Nakshatrala_04_03 as k03  # This module is for graphic components
...
class WidgetsWindow(tk.Tk):
 ...
 #       self.display_activation_functions = k02.DisplayActivationFunctions(self, self.left_frame)
        ...
        self.display_activation_functions = k02.DisplayActivationFunctions(self, self.left_frame, self.right_frame)
        #self.display_graphics = k03.DisplayGraphics(self,self.right_frame)
        ...
        self.left_frame.columnconfigure(0, weight=1, uniform='xx')
        self.left_frame.columnconfigure(1, weight=1, uniform='xx')
...
widgets_window.title('Assignment_04 -- Nakshatrala')
